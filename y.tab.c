...
{
  "$end", "error", "$undefined", "PALAVRA", "COMANDO", "VIRGULA", "NL",
  "DP", "INVALIDO", "$accept", "linhas", "linha", "comando_sp", "comando",
  "erro", "parametro_final", "parametros", "parametro_NL", "parametro",
  "palavra", YY_NULLPTR
};
#endif
...
{
       0,    22,     9,     8,     0,     0,     3,     0,     0,     7,
       0,    15,    14,     0,    17,    18,     0,     1,     2,    10,
       5,    11,    12,     6,     4,    13,    16,    19,    21,    20
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
      -5,    -5,    14,    -5,    -5,    -5,     3,    -5,     2,    12,
       5
};
...
{
      17,    28,    29,     1,     2,    10,     3,     4,    25,     1,
      10,    24,    22,     1,     2,    26,     3,     4,     1,    18,
      19,    20,    21,     1,     1,    27,    11,    23
};

static const yytype_uint8 yycheck[] =
{
       0,     5,     6,     3,     4,     0,     6,     7,     7,     3,
       5,     8,     7,     3,     4,    13,     6,     7,     3,     5,
       5,     6,     7,     3,     3,    13,     6,     6
};
...
{
       0,     3,     4,     6,     7,    10,    11,    12,    13,    14,
      19,     6,    15,    16,    17,    18,    19,     0,    11,     5,
       6,     7,    19,     6,    15,     7,    17,    18,     5,     6
};
